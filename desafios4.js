...
let resposta = prompt('Qual a sua linguagem de mais gosta?');
...
// o resultado em uma terceira variável chamada "resultado". Utilize o console.log para mostrar 
// a mensagem "A diferença entre [valor1] e [valor2] é igual a [resultado]." no console.
let valor11 = 2;
let valor22 = 3;
let resultadoSub = valor22 - valor11;
console.log(`A diferença de ${valor22} e ${valor11} é igual a ${resultadoSub}.`);

// Peça ao usuário para inserir sua idade com prompt. Com base na idade inserida, utilize um if para 
// verificar se a pessoa é maior ou menor de idade, exibindo uma mensagem apropriada no console.
...
// Crie uma variável "nota" e atribua um valor numérico a ela. Use if-else para determinar se a 
// nota é maior ou igual a 7 e exiba "Aprovado" ou "Reprovado" no console.
let nota = 8;
if (nota > 7){
